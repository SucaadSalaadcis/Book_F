  ...
  const from = location.state?.from?.pathname ||"/";
   ...
   const handleRegister = () =>  {
     signUpWithGmail().then((result)=> {
      ...
      // enqueueSnackbar("Sign Up Successfully...",{variant: 'success', position: "top-right"});
      navigate(from, {replace: true});
    })    
    .catch((error) => {
      const errorCode = error.code;
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        <div
          className="absolute inset-0 bg-gradient-to-tr  from-red-400 via-sky-300 to-pink-500 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
        </div>
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="divide-y divide-gray-200">
              <form onSubmit={handleSignUp} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <div className="relative">
                  <button className="font-bold bg-gradient-to-tr  from-red-300 via-sky-200 to-pink-400 text-black rounded-md px-6 py-2">Sign up</button>
                </div>
              </form>
            </div>
            <hr />
